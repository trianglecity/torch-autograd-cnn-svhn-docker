...
DOCKER_DIR_GENERATE := $(if $(BIND_DIR),-v "/home/ml/lua/$(BIND_DIR)")
DOCKER_MOUNT := $(if $(BIND_DIR),-v "$(CURDIR)/$(BIND_DIR):/home/ml/lua/$(BIND_DIR)")

DOCKER_MOUNT := $(if $(DOCKER_MOUNT),$(DOCKER_MOUNT),-v "/home/ml/lua/$(BIND_DIR)")
...
UBUNTU_IMAGE := autograd-cnn-dev:01
